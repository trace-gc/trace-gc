...
`tracegc-crewai` is an official adapter package providing `TraceGC` graph-based context compaction for [CrewAI](https://github.com/crewAIInc/crewAI) agents, crews, and tasks.
