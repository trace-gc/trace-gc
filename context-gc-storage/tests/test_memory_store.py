...
def test_duplicate_event_id_rejection():
    store = MemoryStore()
    cid = store.create()
...
def test_unknown_context_error():
    store = MemoryStore()
    cid = "unknown-id"
